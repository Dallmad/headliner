...
`,_=()=>{const{cartId:s}=D(),r=C(),{setNotification:d}=I(),n=q(),{data:e}=K({queryKey:["cart",s],queryFn:()=>y.getCartById(s),enabled:!!s}),x=()=>{n(R.CARTS)},a=Q({mutationFn:i=>y.updateCart(s,i),onSuccess:i=>{d({message:"Successfully updated cart",type:"success"}),r.setQueryData(["cart",s],i)}}),h=(i,f)=>{if(!e)return;const m=e.products.map(b=>b.id===i?{...b,quantity:f}:b);a.mutate(m)},k=i=>{if(!e)return;const f=e.products.filter(m=>m.id!==i);a.mutate(f)};return t.jsxs(T,{children:[t.jsxs(H,{onClick:x,children:[t.jsx(E,{}),"Back to List"]}),t.jsxs(z,{children:[t.jsx("h2",{children:"Cart Details"}),t.jsxs(L,{children:[t.jsxs("span",{children:[t.jsx(c,{children:"Cart ID"})," ",t.jsxs(u,{children:["# ",e?.id]})]}),t.jsxs("span",{children:[t.jsx(c,{children:"User ID"})," ",t.jsx(u,{children:e?.userId})]})]})]}),t.jsx(U,{children:e?.products?.map(i=>t.jsxs(F,{children:[t.jsxs("div",{children:[t.jsx(c,{children:"Product"}),t.jsx(u,{children:i.title})]}),t.jsxs("div",{children:[t.jsx(c,{children:"Price"}),t.jsx(u,{children:p(i?.price)})]}),t.jsxs(V,{children:[t.jsxs(J,{children:[t.jsx(j,{onClick:()=>h(i.id,i.quantity-1),disabled:i.quantity<=1||a.isPending,children:"-"}),t.jsx("span",{style:{padding:"0 10px"},children:i.quantity}),t.jsx(j,{onClick:()=>h(i.id,i.quantity+1),disabled:a.isPending,children:"+"})]}),t.jsx(W,{onClick:()=>k(i.id),disabled:a.isPending,children:t.jsx(B,{})})]}),t.jsxs("div",{style:{textAlign:"right"},children:[t.jsx(c,{children:"Subtotal"}),t.jsx(u,{children:p(i?.total)})]})]},i.id))}),t.jsxs(N,{children:[t.jsx(c,{children:"Total Amount"}),t.jsx(X,{children:p(e?.total)}),(e?.discountedTotal??0)<(e?.total??0)&&t.jsxs(G,{children:["Discounted price: ",p(e?.discountedTotal)]})]})]})};export{_ as default};
